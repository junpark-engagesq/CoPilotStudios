...
export var PVAChatbotDialog = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DefaultButton, { onClick: toggleHideDialog, className: styles.button, iconProps: { iconName: "CannedChat", styles: { root: { fontSize: "20px", color: "white" } } } }),
        React.createElement(Dialog, { styles: {
                main: { selectors: (_a = {}, _a['@media (min-width: 480px)'] = { width: 350, minWidth: 350, maxWidth: '1000px', position: "absolute", bottom: "120px", right: "20px" }, _a) }
